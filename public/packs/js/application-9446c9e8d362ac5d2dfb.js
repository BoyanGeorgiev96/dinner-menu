...
/***/ "./app/javascript/fridge_items.js":
/*!****************************************!*\
  !*** ./app/javascript/fridge_items.js ***!
  \****************************************/
/*! exports provided: autocompleteSearch, addListenerToButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "autocompleteSearch", function() { return autocompleteSearch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addListenerToButton", function() { return addListenerToButton; });
...
var autocompleteSearch = function autocompleteSearch() {
  $(document).ready(function () {
    if (document.getElementById('search-data')) {
      var measurements = $('#search-data').data('measurements');
      console.log(measurements);
      var ingredients = {
        data: $('#search-data').data('ingredients'),
        list: {
          match: {
            enabled: true,
            method: function method(element, phrase) {
              return !!element.toLowerCase().split(" ").filter(function (word) {
                return word.indexOf(phrase.toLowerCase()) === 0;
              }).length;
            }
          },
          onSelectItemEvent: function onSelectItemEvent() {
            var ingredient = $("#fridge_item_textbox").getSelectedItemData();
...
function changeMeasurement(ingredient, ingredients) {
  var result = ingredients.filter(function (obj) {
  ...
  if (result) {
    ...
    if (measurement) {
      var element = document.querySelector("#fridge_item_ingredient_quantity");
      ...
      if (measurement === "g" || measurement === "kg") {
        ...
        var hiddenFieldMeasurement = document.createElement("input");
...
function createMeasurementDropdown(measurements) {
  var measurementElement = document.createElement("select");
...
function removeHiddenField() {
  var hidden_field = $('#sign_hidden_field');
...
/* harmony import */ var _fridge_items__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../fridge_items */ "./app/javascript/fridge_items.js");
/* harmony import */ var _fortawesome_fontawesome_free_css_all__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fortawesome/fontawesome-free/css/all */ "./node_modules/@fortawesome/fontawesome-free/css/all.css");
/* harmony import */ var _fortawesome_fontawesome_free_css_all__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_fontawesome_free_css_all__WEBPACK_IMPORTED_MODULE_5__);
...
Object(_fridge_items__WEBPACK_IMPORTED_MODULE_4__["autocompleteSearch"])();
Object(_fridge_items__WEBPACK_IMPORTED_MODULE_4__["addListenerToButton"])();
...
/******/ });
//# sourceMappingURL=application-9446c9e8d362ac5d2dfb.js.map